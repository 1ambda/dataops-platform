...
import com.dataops.basecamp.infra.config.QueryDslConfig
...
class QualitySpecRepositoryDslImplTest {
    ...
    inner class Statistics {
        ...
        fun `should return overall statistics`() {
            ...
            // Then
            assertThat(stats.totalSpecs).isEqualTo(4L)
            assertThat(stats.enabledSpecs).isEqualTo(3L)
            assertThat(stats.disabledSpecs).isEqualTo(1L)
        }
        ...
        fun `should return statistics filtered by resource type`() {
            ...
            // Then
            assertThat(stats.totalSpecs).isEqualTo(3L)
            assertThat(stats.enabledSpecs).isEqualTo(3L)
            assertThat(stats.disabledSpecs).isEqualTo(0L)
            assertThat(stats.specsByResourceType[ResourceType.DATASET]).isEqualTo(3L)
        }
        ...
        fun `should return statistics filtered by owner`() {
            ...
            // Then
            assertThat(stats.totalSpecs).isEqualTo(2L)
            assertThat(stats.enabledSpecs).isEqualTo(1L)
            assertThat(stats.disabledSpecs).isEqualTo(1L)
        }
    }
