...
import com.dataops.basecamp.dto.lineage.LineageEdgeDto
import com.dataops.basecamp.dto.lineage.LineageGraphDto
import com.dataops.basecamp.dto.lineage.LineageNodeDto
...
class LineageMapper {
    ...
    /**
     * Convert LineageGraphProjection to LineageGraphDto
     *
     * Main conversion method for the complete lineage graph response.
     */
    fun toGraphDto(result: LineageGraphProjection): LineageGraphDto {
