...
object DatasetMapper {
     ...
     */
    fun toDto(entity: DatasetEntity): DatasetDto =
        DatasetDto(
            name = entity.name,
            type = "Dataset",
            owner = entity.owner,
     ...
     */
    fun toListDto(entity: DatasetEntity): DatasetListDto =
        DatasetListDto(
            name = entity.name,
            type = "Dataset",
            owner = entity.owner,
     ...
     */
    fun toDatasetExecutionTimeoutError(
        datasetName: String,
        timeoutSeconds: Int,
    ): ErrorResponse =
        toErrorResponse(
     ...
     */
    fun toDatasetExecutionFailedError(
        datasetName: String,
        sqlError: String,
    ): ErrorResponse =
        toErrorResponse(
