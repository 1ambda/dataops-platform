...
import com.github.lambda.domain.service.WorkflowSpecSyncService
...
import com.github.lambda.mapper.AirflowSyncMapper
 ...
 */
@WebMvcTest(AirflowSyncController::class)
@Import(
    SecurityConfig::class,
    GlobalExceptionHandler::class,
    AirflowSyncControllerTest.ValidationConfig::class,
)
@ActiveProfiles("test")
...
class AirflowSyncControllerTest {
    ...
    private lateinit var testSpecSyncResult: SpecSyncResult
    private lateinit var testRunSyncResult: RunSyncResult
    private lateinit var testClusterSyncResult: ClusterSyncResult
