...
class CatalogMapperTest {
    ...
    inner class TestStatusMapping {
        @Test
        @DisplayName("should map TestStatus.PASSED to lowercase string")
        fun `should map TestStatus PASSED to lowercase string`() {
            // Given
            val testResult =
                QualityTestResult(
                    testName = "test",
        ...
        @Test
        @DisplayName("should map TestStatus.FAILED to lowercase string")
        fun `should map TestStatus FAILED to lowercase string`() {
            // Given
            val testResult =
                QualityTestResult(
                    testName = "test",
        ...
        @Test
        @DisplayName("should map TestStatus.ERROR to lowercase string")
        fun `should map TestStatus ERROR to lowercase string`() {
            // Given
            val testResult =
                QualityTestResult(
                    testName = "test",
