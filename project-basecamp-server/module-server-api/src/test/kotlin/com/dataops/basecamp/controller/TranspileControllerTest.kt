...
import com.dataops.basecamp.config.SecurityConfig
import com.dataops.basecamp.domain.projection.transpile.*
import com.dataops.basecamp.domain.service.*
import com.dataops.basecamp.dto.transpile.TranspileResultDto
import com.dataops.basecamp.dto.transpile.TranspileRulesDto
import com.dataops.basecamp.exception.GlobalExceptionHandler
import com.dataops.basecamp.mapper.TranspileMapper
    ...
    fun setUp() {
        ...
        testTranspileRulesDto =
            TranspileRulesDto(
                ...
                rules = emptyList(),
                metadata =
                    com.dataops.basecamp.dto.transpile.TranspileMetadataDto(
                        createdAt = Instant.parse("2024-01-01T09:00:00Z"),
                        createdBy = "system",
                        totalRules = 0,
                        cacheTtlSeconds = 3600,
