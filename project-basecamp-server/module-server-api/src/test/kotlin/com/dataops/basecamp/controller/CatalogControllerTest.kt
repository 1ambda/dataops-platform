 ...
 *
 * Spring Boot 4.x patterns for multi-module projects:
 * - @SpringBootTest: Required for multi-module projects where controllers are in separate modules
...
class CatalogControllerTest {
    ...
    @MockkBean(relaxed = true)
    private lateinit var queryService: com.dataops.basecamp.domain.service.QueryService

    @MockkBean(relaxed = true)
    private lateinit var queryMapper: com.dataops.basecamp.mapper.QueryMapper

    // Lineage-related mock beans to fix test context loading
    @MockkBean(relaxed = true)
    private lateinit var lineageService: com.dataops.basecamp.domain.service.LineageService

    @MockkBean(relaxed = true)
    private lateinit var lineageNodeRepositoryJpa:
        com.dataops.basecamp.domain.repository.lineage.LineageNodeRepositoryJpa

    @MockkBean(relaxed = true)
    private lateinit var lineageEdgeRepositoryDsl:
        com.dataops.basecamp.domain.repository.lineage.LineageEdgeRepositoryDsl

    @MockkBean(relaxed = true)
    private lateinit var lineageMapper: com.dataops.basecamp.mapper.LineageMapper

    @MockkBean(relaxed = true)
    private lateinit var basecampParserClient: com.dataops.basecamp.domain.external.parser.BasecampParserClient
