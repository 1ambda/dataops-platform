...
2. [HTTP Status Codes Guide](#http-status-codes-guide)
3. [Server Error Codes Catalog](#server-error-codes-catalog)
4. [CLI Error Code Mapping](#cli-error-code-mapping)
...
## Server Error Codes Catalog

### P0 Critical APIs Error Codes
...
### Error Message Formatting for CLI
...
- **Implementation Guide**: [IMPLEMENTATION_GUIDE.md](./IMPLEMENTATION_GUIDE.md) - Service layer patterns
- **Architecture**: [ARCHITECTURE.md](./ARCHITECTURE.md) - System design and policies
- **CLI Error Mapping**: [project-basecamp-server/features/CLI_API_MAPPING.md](../project-basecamp-server/features/CLI_API_MAPPING.md)
- **API Specifications**: [project-basecamp-server/features/METRIC_FEATURE.md](../project-basecamp-server/features/METRIC_FEATURE.md)
