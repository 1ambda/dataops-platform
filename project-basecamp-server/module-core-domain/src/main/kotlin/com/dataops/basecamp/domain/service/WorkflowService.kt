...
import com.dataops.basecamp.domain.command.workflow.WorkflowParseResult
...
class WorkflowService(
    ...
    // === Spec Sync (WorkflowSpecSyncService integrated) ===
    ...
    private fun syncSingleSpec(specPath: String): SyncAction {
        ...
        // 2. YAML 파싱 및 유효성 검사
        val parseResult = parseYaml(yamlContent)
     ...
     */
    private fun parseYaml(yamlContent: String): WorkflowParseResult {
