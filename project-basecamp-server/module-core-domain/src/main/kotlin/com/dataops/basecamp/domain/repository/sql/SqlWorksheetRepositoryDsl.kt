...
/**
 * SQL Worksheet Repository DSL 인터페이스 (순수 도메인 추상화)
 *
 * SQL Worksheet에 대한 복잡한 쿼리 작업을 정의합니다.
 * QueryDSL이나 기타 복잡한 쿼리 기술에 대한 추상화를 제공합니다.
 */
interface SqlWorksheetRepositoryDsl {
    /**
     * Project 내의 Worksheet 목록을 조건에 따라 페이징 조회
     *
     ...
     * @return 페이징된 Worksheet 목록 (soft delete 제외)
     */
    ...
    /**
     * Folder ID 목록에 해당하는 Worksheet 개수를 Folder별로 조회
     *
