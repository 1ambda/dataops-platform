...
class AirflowRunSyncService(
    ...
    fun syncCluster(
        ...
        val cluster =
            clusterRepository.findById(clusterId)
                ?: return ClusterSyncResult.failure(
                    clusterId = clusterId,
                    clusterName = "unknown",
     ...
     */
    @Transactional
    fun syncStaleRuns(staleThresholdHours: Long = 1): RunSyncResult {
        ...
        return RunSyncResult.single(result)
    }
    ...
    private fun doSyncCluster(
        ...
        return ClusterSyncResult.success(
            clusterId = cluster.id!!,
            clusterName = cluster.team,
            updatedCount = updatedCount,
    ...
    private fun fetchTaskProgress(
        ...
        try {
            ...
            TaskProgress.fromTaskStates(taskStates)
        } catch (e: Exception) {
