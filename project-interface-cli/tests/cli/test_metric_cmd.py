...
class TestMetricTranspile:
    ...
    def test_transpile_metric_with_strict_mode(self, sample_project_path: Path) -> None:
        """Test metric transpilation with strict mode enabled."""
        result = runner.invoke(
            app,
            [
                "metric",
    ...
    def test_transpile_metric_with_show_rules(
        self, sample_project_path: Path
    ) -> None:
        """Test metric transpilation with --show-rules option."""
        result = runner.invoke(
            app,
            [
                "metric",
    ...
    def test_transpile_metric_unknown_dialect(self, sample_project_path: Path) -> None:
        """Test metric transpilation with unknown dialect.
    ...
    def test_transpile_metric_invalid_file(
        self, sample_project_path: Path
    ) -> None:
        """Test metric transpilation with nonexistent SQL file via --file option."""
        result = runner.invoke(
            app,
            [
                "metric",
    ...
    def test_transpile_metric_with_all_options(
        ...
        """Test metric transpilation with all available options combined."""
